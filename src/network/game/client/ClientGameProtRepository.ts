...
import ResumePStringDialogDecoder from '#/network/game/client/codec/ResumePStringDialogDecoder.js';
...
import ResumePStringDialogHandler from '#/network/game/client/handler/ResumePStringDialogHandler.js';
...
class ClientGameProtRepository {
    ...
    constructor() {
        ...
        this.bind(new ResumePStringDialogDecoder(), new ResumePStringDialogHandler());
